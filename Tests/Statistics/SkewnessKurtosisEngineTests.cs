...
namespace ResearchFeatureEngine.Tests.Statistics
{
    ...
    public sealed class SkewnessKurtosisEngineTests
    {
        ...
        // ---------------------------------------------------------
        // J. LogReturn / L. SimpleReturn source-integration tests are
        // deliberately NOT part of this commit: they exercise the
        // StatisticsSource materialization plumbing, which is pending
        // uncommitted work. They live in the working tree (full file)
        // and travel with that commit. See
        // SkewnessKurtosisSourceTests.cs for the source-dependent
        // tests.
        // ---------------------------------------------------------
